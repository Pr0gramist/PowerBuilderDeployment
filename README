...
PackagePath - String of current location your PowerBuilder packages are located (In a few places this needs to be changed for every user to point to their current PowerBuilder package location)
